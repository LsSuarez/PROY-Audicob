        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IngresosMensuales = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    DeudaTotal = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "AsignacionesAsesores",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    AsesorUserId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    AsesorNombre = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: false),
                    FechaAsignacion = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ClienteId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AsignacionesAsesores", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Intereses = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    PenalidadCalculada = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    TotalAPagar = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FechaAsignacion = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UsuarioAsignador = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: false),
                    ClienteId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LineasCredito", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LineasCredito_Clientes_ClienteId",
                        column: x => x.ClienteId,
                        principalTable: "Clientes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LineasCredito_ClienteId",
                table: "LineasCredito",
                column: "ClienteId",
                unique: true);
